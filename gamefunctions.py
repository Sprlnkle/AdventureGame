...
def draw_grid(screen, player_pos, monster_pos=None):
    ...
    # Randomize monster position because not done in main anymore
    if monster_pos is None:
        monster_pos = [random.randint(0, 9), random.randint(0, 9)]

    # Draw the monster
    monster_color = (255, 0, 0)  # Red
    ...
    pygame.draw.circle(screen, town_color, (9 * 32 + 16, 9 * 32 + 16), 16)  # Circle at [9, 9]
