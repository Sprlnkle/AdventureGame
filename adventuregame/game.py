...
item_stats = {
 ...
 #   "Arrow": {"price": 2.5, "durability": 1, "multiplier": 0.5}, got confused and gave up on making arrows work for now
                ...
                for event in pygame.event.get():
                    if event.type == pygame.QUIT:
                        ...
                        if player_pos == monster_pos:
                            ...
                            pygame.quit()
                            gold_reward = gamefunctions.fight_manager(playerhealth=50, playerdmg=5, inventory=inventory, monster=monster, Gold=Gold)
                            Gold += gold_reward
                            running = False
                            break
